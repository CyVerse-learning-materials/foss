...
In conjunction with our Policies [link to Policies page] for using CyVerse cyberinfrastructure, this Code of Conduct applies to all Event participants and their activities while using CyVerse resources.
...
When using CyVerse, we expect you to:

- Conduct your research professionally and ethically by complying with our Policies.
- Follow the Golden Rule (treat others as you want to be treated) when interacting online or in-person with collaborators and support and training staff. 
...
To report a violation of this Code, email info@cyverse.org with the following information:
